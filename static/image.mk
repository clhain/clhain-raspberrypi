...
# convert it to ext4
	$(STAGING_DIR_HOST)/bin/tune2fs -O extents,uninit_bg,dir_index,has_journal $(KDIR)/root.ext4
# fix it up
...
define Image/mkfs/prepare/default
	...
	- $(FIND) $(TARGET_DIR) -type f -not -perm +0100 -not -name 'ssh_host*' -not -name 'shadow' -not -name 'sudo' -not -name 'sudoers' -not -name 'wmdsudoers' -not -name 'appengineid' -print0 | $(XARGS) -0 chmod u+rw,g+r,o+r
	- $(FIND) $(TARGET_DIR) -type f -perm +0100 -not -name 'sudo' -print0 | $(XARGS) -0 chmod u+rwx,g+rx,o+rx
	- $(FIND) $(TARGET_DIR) -type d -not -name 'local_rw' -print0 | $(XARGS) -0 chmod u+rwx,g+rx,o+rx
